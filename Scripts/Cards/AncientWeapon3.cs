...
public class AncientWeapon3 : ModCardTemplate
{
    ...
    public AncientWeapon3() : base(energyCost, type, rarity, targetType, shouldShowInCardLibrary)
    {
    }
    ...
    protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
    {
        ...
        CardModel card = CombatState.CreateCard<AncientWeaponLiberate>(Owner);
        if (IsUpgraded)
        {
