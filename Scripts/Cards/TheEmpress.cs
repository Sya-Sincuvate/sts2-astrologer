...
public class TheEmpress : ModCardTemplate
{
    ...
    public override CardAssetProfile AssetProfile => new(
        PortraitPath: $"res://Astrologer/images/cards/TheEmpress.png"
    );
    ...
    public TheEmpress() : base(energyCost, type, rarity, targetType, shouldShowInCardLibrary)
    {
    }
