...
public class Starburst : ModCardTemplate
{
    ...
    public override CardAssetProfile AssetProfile => new(
        PortraitPath: $"res://Astrologer/images/cards/Starburst.png"
    );
    ...
    protected override IEnumerable<DynamicVar> CanonicalVars => [
        ...
        new DynamicVar("Ast", 1m)
    ];

    public Starburst() : base(energyCost, type, rarity, targetType, shouldShowInCardLibrary)
    {
    }
    ...
    protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
    {
        ...
        for (int i = 0; i < DynamicVars["Ast"].BaseValue; i++)
        {
    ...
    protected override void OnUpgrade()
    {
        ...
        DynamicVars["Ast"].UpgradeValueBy(1m);
    }
}