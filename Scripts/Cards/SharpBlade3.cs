...
public class SharpBlade3 : ModCardTemplate
{
    ...
    public SharpBlade3() : base(energyCost, type, rarity, targetType, shouldShowInCardLibrary)
    {
    }
    ...
    protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
    {
        ...
        CardModel card = CombatState.CreateCard<SharpBladeLiberate>(Owner);
        if (IsUpgraded)
        {
