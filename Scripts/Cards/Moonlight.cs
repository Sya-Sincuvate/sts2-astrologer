...
public class Moonlight : ModCardTemplate
{
    ...
    public override CardAssetProfile AssetProfile => new(
        PortraitPath: $"res://Astrologer/images/cards/Moonlight.png"
    );
    ...
    public Moonlight() : base(energyCost, type, rarity, targetType, shouldShowInCardLibrary)
    {
    }
