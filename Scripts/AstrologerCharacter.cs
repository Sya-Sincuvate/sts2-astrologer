...
[RegisterCharacter]
public class AstrologerCharacter : ModCharacterTemplate<AstrologerCardPool, AstrologerRelicPool, AstrologerPotionPool>
{
    // 角色名称颜色
    public override Color NameColor => new(0.76f, 0.856f, 1f);
    // 能量图标轮廓颜色
    public override Color EnergyLabelOutlineColor => new(0.76f, 0.856f, 1f);
    // 地图绘制颜色
    public override Color MapDrawingColor => new(0.76f, 0.856f, 1f);
    ...
    public override CharacterAssetProfile AssetProfile => CharacterAssetProfiles.Merge(
        ...
        new(
            Scenes: new(
                // 人物模型tscn路径。
                VisualsPath: "res://Astrologer/scenes/astrologer_character.tscn",
                // 能量表盘tscn路径。
                EnergyCounterPath: "res://Astrologer/scenes/astrologer_energy_counter.tscn",
                // 商店人物场景。
                MerchantAnimPath: "res://Astrologer/scenes/astrologer_character_merchant.tscn",
                // 篝火休息场景。
                RestSiteAnimPath: "res://Astrologer/scenes/astrologer_character_rest_site.tscn"
            ),
            Ui: new(
                // 对于图片，只要是godot支持的格式都可以，例如png,jpg,svg等等，之后不再说明
                // 人物头像路径。自适应大小。
                IconTexturePath: "res://Astrologer/images/ui/Avatar.png",
                // 游戏左上角头像、角色统计页头像、每日挑战角色头像。这个是场景而不是图片。参考下方附赠资源搭建。
                IconPath: "res://Astrologer/scenes/astrologer_icon.tscn",
                // 人物选择背景。
                CharacterSelectBgPath: "res://Astrologer/scenes/astrologer_bg.tscn",
                // 人物选择图标。
                CharacterSelectIconPath: "res://Astrologer/images/ui/char_select.png",
                // 人物选择图标-锁定状态。
                CharacterSelectLockedIconPath: "res://Astrologer/images/ui/char_select_locked.png",
                // 人物选择过渡动画。
                // CharacterSelectTransitionPath: "res://materials/transitions/ironclad_transition_mat.tres",
                // 地图上的角色标记图标、表情轮盘上的角色头像。
                MapMarkerPath: "res://Astrologer/images/ui/Avatar.png"
            ),
            Vfx: new(
            // 卡牌拖尾场景。
